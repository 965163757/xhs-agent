...
- 对复杂创作或"从0到1完整做一篇/一键成稿/给我完整方案"类请求，优先调用 create_complete_note_workflow，一次性交付策略、成稿、标题候选、标签、视觉方向和自检结果
...
- 若用户没有指定只要某个小步骤，默认使用 create_complete_note_workflow；只有在用户明确要求"只要标题/只要标签/只润色一段"时才调用单点工具
